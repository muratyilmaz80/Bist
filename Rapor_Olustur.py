...
def exportReportExcel(hisse,file,bilancoDonemi,ExcelRowClass):
    ...
    def createTopRow():
        ...
        bookSheetWrite.write(0, 46, "Tarih")
        bookSheetWrite.write(0, 47, "Net Kar Büyüme Yıllık")
        bookSheetWrite.write(0, 48, "Net Kar Büyüme 4 Önceki Çeyreğe Göre")
        bookSheetWrite.write(0, 49, "Esas Faaliyet Karı Büyüme Yıllık")
        bookSheetWrite.write(0, 50, "Hasılat Büyüme Yıllık")
        bookSheetWrite.write(0, 51, "FAVÖK Büyüme Yıllık")
        bookSheetWrite.write(0, 52, "F/K")
        bookSheetWrite.write(0, 53, "Nakit/PD")
        bookSheetWrite.write(0, 54, "Nakit/FD")
        bookSheetWrite.write(0, 55, "PD/DD")
        bookSheetWrite.write(0, 56, "PEG")
        bookSheetWrite.write(0, 57, "FD/Satışlar")
        bookSheetWrite.write(0, 58, "FD/FAVÖK")
        bookSheetWrite.write(0, 59, "PD/EFK")
        bookSheetWrite.write(0, 60, "Cari Oran")
        bookSheetWrite.write(0, 61, "Likit Oranı")
        bookSheetWrite.write(0, 62, "Nakit Oranı")
        bookSheetWrite.write(0, 63, "Asit Test Oranı")
        bookSheetWrite.write(0, 64, "ROE (Özsermaye Karlılığı)")
        bookSheetWrite.write(0, 65, "ROA (Aktif Karlılık)")
        bookSheetWrite.write(0, 66, "Yıllık Net Kar Marjı")
        bookSheetWrite.write(0, 67, "Son Çeyrek Net Kar Marjı")
        bookSheetWrite.write(0, 68, "Aktif Devir Hızı")
        bookSheetWrite.write(0, 69, "Borç/Kaynak")
        bookSheetWrite.write(0, 70, "Özsermaye Büyümesi")
        bookSheetWrite.write(0, 71, "Halka Açıklık Oranı")
        bookSheetWrite.write(0, 72, "Piyasa Değeri Milyon TL")
        bookSheetWrite.write(0, 73, "Sermaye Milyon TL")
        bookSheetWrite.write(0, 74, "Sermaye Artırım Potansiyeli")
    ...
    def reportResults(rowNumber):
        ...
        bookSheetWrite.write(rowNumber, 8, ExcelRowClass.oncekiBilancoDonemiHasilatDegisimiGecmeDurumu)
        ...
        bookSheetWrite.write(rowNumber, 16, ExcelRowClass.oncekiBilancoDonemiFaaliyetKarDegisimiGecmeDurumu)
        ...
        bookSheetWrite.write(rowNumber, 23, ExcelRowClass.oncekiBilancoDonemiDolarHasilatDegisimiGecmeDurumu)
        ...
        bookSheetWrite.write(rowNumber, 29, ExcelRowClass.oncekiBilancoDonemiDolarFaaliyetKariDegisimiGecmeDurumu)
        ...
        bookSheetWrite.write(rowNumber, 46, ExcelRowClass.tarih)
        bookSheetWrite.write(rowNumber, 47, ExcelRowClass.netKarBuyumeYillik)
        bookSheetWrite.write(rowNumber, 48, ExcelRowClass.netKarBuyume4OncekiCeyregeGore)
        bookSheetWrite.write(rowNumber, 49, ExcelRowClass.esasFaaliyetKariBuyumeYillik)
        bookSheetWrite.write(rowNumber, 50, ExcelRowClass.hasilatBuyumeYillik)
        bookSheetWrite.write(rowNumber, 51, ExcelRowClass.favokBuyumeYillik)
        bookSheetWrite.write(rowNumber, 52, ExcelRowClass.fkOrani)
        bookSheetWrite.write(rowNumber, 53, ExcelRowClass.nakitPd)
        bookSheetWrite.write(rowNumber, 54, ExcelRowClass.nakitFd)
        bookSheetWrite.write(rowNumber, 55, ExcelRowClass.pdDd)
        bookSheetWrite.write(rowNumber, 56, ExcelRowClass.pegOrani)
        bookSheetWrite.write(rowNumber, 57, ExcelRowClass.fdSatislar)
        bookSheetWrite.write(rowNumber, 58, ExcelRowClass.fdFavok)
        bookSheetWrite.write(rowNumber, 59, ExcelRowClass.pdEfk)
        bookSheetWrite.write(rowNumber, 60, ExcelRowClass.cariOran)
        bookSheetWrite.write(rowNumber, 61, ExcelRowClass.likitOrani)
        bookSheetWrite.write(rowNumber, 62, ExcelRowClass.nakitOrani)
        bookSheetWrite.write(rowNumber, 63, ExcelRowClass.asitTestOrani)
        bookSheetWrite.write(rowNumber, 64, ExcelRowClass.roe)
        bookSheetWrite.write(rowNumber, 65, ExcelRowClass.roa)
        bookSheetWrite.write(rowNumber, 66, ExcelRowClass.yillikNetKarMarji)
        bookSheetWrite.write(rowNumber, 67, ExcelRowClass.sonCeyrekNetKarMarji)
        bookSheetWrite.write(rowNumber, 68, ExcelRowClass.aktifDevirHizi)
        bookSheetWrite.write(rowNumber, 69, ExcelRowClass.borcKaynak)
        bookSheetWrite.write(rowNumber, 70, ExcelRowClass.ozsermayeBuyumesi)
        bookSheetWrite.write(rowNumber, 71, ExcelRowClass.halkaAciklikOrani)
        bookSheetWrite.write(rowNumber, 72, ExcelRowClass.piyasaDegeri)
        bookSheetWrite.write(rowNumber, 73, ExcelRowClass.sermaye)
        bookSheetWrite.write(rowNumber, 74, ExcelRowClass.sermayeArtirimPotansiyeli)
